...
#' @param which logical: should only case/row numbers be displayed
#' @param percase logical: show missings per case/row
#' 
#'
#' @return case numbers or LOGICAL
#' @export
#'
#' @examples
...
row.has.na <- function (data, which=TRUE, percase=FALSE) {
